...
interface ApiService {
     ...
     */
    @GET("empleador/estadisticas")
    suspend fun obtenerEstadisticasEmpleador(
        @Header("Authorization") token: String
    ): Response<EmpleadorEstadisticas>

    /**
     * Obtiene todos los empleos del empleador con sus postulaciones.
     */
    @GET("empleador/mis-empleos")
    suspend fun obtenerMisEmpleosConPostulaciones(
        @Header("Authorization") token: String
    ): Response<List<EmpleoConPostulaciones>>

    /**
     * Obtiene los postulantes de un empleo específico.
     */
    @GET("empleador/empleo/{empleoId}/postulantes")
    suspend fun obtenerPostulantesDeEmpleo(
        @Header("Authorization") token: String,
        @Path("empleoId") empleoId: Long
    ): Response<List<Postulante>>
     ...
     */
    @PUT("empleador/postulacion/{postulacionId}/estado")
     ...
     * Finaliza un empleo.
     */
    @PUT("empleador/empleo/{empleoId}/finalizar")
    suspend fun finalizarEmpleo(
        @Header("Authorization") token: String,
        @Path("empleoId") empleoId: Long
    ): Response<Map<String, String>>
